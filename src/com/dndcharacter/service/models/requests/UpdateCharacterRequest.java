...
public class UpdateCharacterRequest {
    ...
    public UpdateCharacterRequest(Builder builder) {
    ...
    public boolean equals(Object obj) {
        ...
        var that = (UpdateCharacterRequest) obj;
    ...
    public static final class Builder {
        ...
        public Builder withExpPoints(int exp) {
            this.expPoints = exp;
            return this;
        }
        ...
        public Builder withCurrentHealth(int current) {
